	...
	if (error) {
		...
		serverConnection.query(
			...
			(error, result) => {
				...
				console.log(
					"\tdatabase.js banking_system database created if not exists"
				);
				selectDatabase();
			}
		);
...
function createTables() {
	...
	serverConnection.execute(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: Role table created successfully if it didn't previously exist"
		);
	});
	...
	serverConnection.execute(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: User table created successfully if it didn't previously exist"
		);
	});
	...
	serverConnection.execute(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: User table altered successfully to AUTO_INCREMENT = 1000000"
		);
	});
	...
	serverConnection.execute(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: Account table altered successfully to AUTO_INCREMENT = 100000"
		);
	});
	...
	serverConnection.execute(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: Transfer table created successfully if it didn't previously exist"
		);
	});
}
//#endregion
...
function createStoredProcedures() {
	...
	serverConnection.query(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: Stored Procedure create_role created successfully"
		);
	});
	// Create roles
	CreateRole("admin");
	...
	serverConnection.query(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: Stored Procedure create_user created successfully"
		);
	});
	...
	serverConnection.query(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: Stored Procedure create_transfer created successfully"
		);
	});
	...
	serverConnection.query(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: Stored Procedure create_account created successfully"
		);
	});
	...
	serverConnection.query(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: Stored Procedure create_user_role created successfully"
		);
	});
...
async function addTableData() {
	if (!(await DatabaseHasBeenSeeded())) {
		...
		for (let i = 1; i < 3; ++i) {
			...
			console.log(
				"\tdatabase.ejs: Account type with account_type_id: " +
					i +
					" is " +
					accountType
			);
...
function CreateUser(
	...
	serverConnection.query(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: CALL create_user to create user " +
				firstName +
				" " +
				lastName
		);
...
function CreateAccountType(accountType) {
	...
	serverConnection.query(sql, (error, results, fields) => {
		...
		console.log(
			"\tdatabase.js: CALL create_account_type to create " +
				accountType +
				" account type"
		);
	});
...
function ChangeUserHashedPasswordById(userId, newHashedPassword) {
	let sql =
		"CALL change_user_hashed_password_by_user_id('" +
		userId +
		"', '" +
		newHashedPassword +
		"')";
...
function UpdateAccountBalanceByAccountNumber(amountToAdd, accountNumber) {
	let sql =
		"CALL update_account_balance_by_account_number('" +
		amountToAdd +
		"', " +
		accountNumber +
		")";
...
function GetUserDataByEmail(email) {
    let sql = 'SELECT user_id, first_name, last_name, role_id FROM user WHERE user.email = "' + email + '"';
	return new Promise((resolve, reject) => {
		serverConnection.query(sql, (error, results, fields) => {
			if (error) {
				console.log(error.message);
